package marketplaces.backend.backendrestapi.config.security.config;

import marketplaces.backend.backendrestapi.config.security.actors.UserPrincipalDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/sys/users").hasAuthority("ACCESS_READ")
